...
export class CheckoutComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.luv2ShopFormService.getCountries().subscribe(
      data => { console.log("Countries data: ", data); this.countries = data}
    )
  }
  ...
  onSubmit() {
    ...
    if (this.checkoutFormGroup.invalid) {
      console.log("invalid form data:", this.checkoutFormGroup.errors);
    ...
    console.log(`purchase shippingAddress: ${purchase.shippingAddress}`);
    ...
    console.log(`purchase billingAddress: ${purchase.billingAddress}`);
